...
def train_epoch(fold, model, loader, optimizer):
    ...
    for i, (data, target) in enumerate(bar):
        ...
        loss = (loss * fold_weights[fold].to(device)).mean()
...
if __name__ == '__main__':
    ...
    fold_weights = torch.tensor([
        [121565 / (5 * 3680), 121565 / (5 * 7368), 121565 / (5 * 13533), 121565 / (5 * 35387), 121565 / (5 * 30229)],
        [121668 / (5 * 3758), 121668 / (5 * 7479), 121668 / (5 * 13507), 121668 / (5 * 35706), 121668 / (5 * 30305)],
        [121885 / (5 * 3777), 121885 / (5 * 7301), 121885 / (5 * 13697), 121885 / (5 * 35561), 121885 / (5 * 30383)],
        [121650 / (5 * 3905), 121650 / (5 * 7531), 121650 / (5 * 13761), 121650 / (5 * 35285), 121650 / (5 * 30166)]
    ])
