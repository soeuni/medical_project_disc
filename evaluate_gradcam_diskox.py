...
def main():
    ...
    high_confidence_csv = pd.read_csv(f'./confidence/{args.kernel_type}_confidence/{args.kernel_type}_high_confidence.csv')[:200]
    ...
    for idx in range(len(high_confidence_csv)):
        ...
        cv2.imwrite(f'./gradcam_image/{args.kernel_type}_gradcam_image/{high_confidence_csv["correct_prob"][idx]:.2f}_{high_confidence_csv["image_name"][idx]}', cam_image)
    ...
    for idx in range(len(high_confidence_csv)):
        ...
        img.save(f'./gradcam_image/{args.kernel_type}_gradcam_image/{high_confidence_csv["correct_prob"][idx]:.2f}_{high_confidence_csv["image_name"][idx][:-4]}.png')
...
if __name__ == '__main__':
    ...
    os.makedirs(f'./gradcam_image/{args.kernel_type}_gradcam_image/', exist_ok=True)
